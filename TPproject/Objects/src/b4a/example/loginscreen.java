...
_infoholder.setColor(__c.Colors.ARGB((int) (150),(int) (0),(int) (0),(int) (0)));
 //BA.debugLineNum = 45;BA.debugLine="wholescreen.AddView(infoholder,30%x,100%y,40%x,30";
_wholescreen.AddView((android.view.View)(_infoholder.getObject()),__c.PerXToCurrent((float) (30),ba),__c.PerYToCurrent((float) (100),ba),__c.PerXToCurrent((float) (40),ba),__c.PerYToCurrent((float) (30),ba));
 //BA.debugLineNum = 46;BA.debugLine="usernamefield.Gravity = Gravity.LEFT";
_usernamefield.setGravity(__c.Gravity.LEFT);
 //BA.debugLineNum = 47;BA.debugLine="usernamefield.Color = Colors.White";
_usernamefield.setColor(__c.Colors.White);
 //BA.debugLineNum = 49;BA.debugLine="usernamefield.Text = \"pump\"";
_usernamefield.setText(BA.ObjectToCharSequence("pump"));
 //BA.debugLineNum = 50;BA.debugLine="usernamefield.HintColor = Colors.DarkGray";
_usernamefield.setHintColor(__c.Colors.DarkGray);
 //BA.debugLineNum = 51;BA.debugLine="usernamefield.SingleLine = True";
_usernamefield.setSingleLine(__c.True);
 //BA.debugLineNum = 52;BA.debugLine="usernamefield.TextColor = Colors.Black";
_usernamefield.setTextColor(__c.Colors.Black);
 //BA.debugLineNum = 53;BA.debugLine="infoholder.AddView(usernamefield,2.5%x,2.5%y,35%x";
_infoholder.AddView((android.view.View)(_usernamefield.getObject()),__c.PerXToCurrent((float) (2.5),ba),__c.PerYToCurrent((float) (2.5),ba),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (5),ba));
 //BA.debugLineNum = 55;BA.debugLine="passwordfield.Gravity = Gravity.LEFT";
_passwordfield.setGravity(__c.Gravity.LEFT);
 //BA.debugLineNum = 56;BA.debugLine="passwordfield.Color = Colors.White";
_passwordfield.setColor(__c.Colors.White);
 //BA.debugLineNum = 58;BA.debugLine="passwordfield.Text = \"12345\"";
_passwordfield.setText(BA.ObjectToCharSequence("12345"));
 //BA.debugLineNum = 59;BA.debugLine="passwordfield.HintColor = Colors.DarkGray";
_passwordfield.setHintColor(__c.Colors.DarkGray);
 //BA.debugLineNum = 60;BA.debugLine="passwordfield.PasswordMode = True";
_passwordfield.setPasswordMode(__c.True);
 //BA.debugLineNum = 61;BA.debugLine="passwordfield.SingleLine = True";
_passwordfield.setSingleLine(__c.True);
 //BA.debugLineNum = 62;BA.debugLine="passwordfield.TextColor = Colors.Black";
_passwordfield.setTextColor(__c.Colors.Black);
 //BA.debugLineNum = 63;BA.debugLine="infoholder.AddView(passwordfield,2.5%x,(usernamef";
_infoholder.AddView((android.view.View)(_passwordfield.getObject()),__c.PerXToCurrent((float) (2.5),ba),(int) ((_usernamefield.getTop()+_usernamefield.getHeight())+__c.DipToCurrent((int) (10))),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (5),ba));
 //BA.debugLineNum = 65;BA.debugLine="loginbtn.Gravity = Gravity.CENTER";
_loginbtn.setGravity(__c.Gravity.CENTER);
 //BA.debugLineNum = 66;BA.debugLine="loginbtn.Color = Colors.White";
_loginbtn.setColor(__c.Colors.White);
 //BA.debugLineNum = 67;BA.debugLine="loginbtn.Text = \"Login\"";
_loginbtn.setText(BA.ObjectToCharSequence("Login"));
 //BA.debugLineNum = 68;BA.debugLine="loginbtn.TextSize = 20";
_loginbtn.setTextSize((float) (20));
 //BA.debugLineNum = 69;BA.debugLine="loginbtn.Textcolor = Colors.Black";
_loginbtn.setTextColor(__c.Colors.Black);
 //BA.debugLineNum = 70;BA.debugLine="HelperFunctions1.Apply_ViewStyle(loginbtn,Colors.";
_helperfunctions1._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_loginbtn.getObject())),__c.Colors.Black,__c.Colors.RGB((int) (0),(int) (128),(int) (255)),__c.Colors.White,__c.Colors.RGB((int) (77),(int) (166),(int) (255)),__c.Colors.Gray,__c.Colors.Gray,__c.Colors.Gray,(int) (10));
 //BA.debugLineNum = 71;BA.debugLine="infoholder.AddView(loginbtn,2.5%x,(passwordfield.";
_infoholder.AddView((android.view.View)(_loginbtn.getObject()),__c.PerXToCurrent((float) (2.5),ba),(int) ((_passwordfield.getTop()+_passwordfield.getHeight())+__c.PerYToCurrent((float) (5),ba)),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (5),ba));
 //BA.debugLineNum = 73;BA.debugLine="singup.Gravity = Gravity.CENTER";
_singup.setGravity(__c.Gravity.CENTER);
 //BA.debugLineNum = 74;BA.debugLine="singup.Color = Colors.White";
_singup.setColor(__c.Colors.White);
 //BA.debugLineNum = 75;BA.debugLine="singup.Text = \"Sing up\"";
_singup.setText(BA.ObjectToCharSequence("Sing up"));
 //BA.debugLineNum = 76;BA.debugLine="singup.TextSize = 20";
_singup.setTextSize((float) (20));
 //BA.debugLineNum = 77;BA.debugLine="singup.Textcolor = Colors.Black";
_singup.setTextColor(__c.Colors.Black);
 //BA.debugLineNum = 78;BA.debugLine="HelperFunctions1.Apply_ViewStyle(singup,Colors.Bl";
_helperfunctions1._apply_viewstyle(ba,(anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(_singup.getObject())),__c.Colors.Black,__c.Colors.RGB((int) (0),(int) (128),(int) (255)),__c.Colors.White,__c.Colors.RGB((int) (77),(int) (166),(int) (255)),__c.Colors.Gray,__c.Colors.Gray,__c.Colors.Gray,(int) (10));
 //BA.debugLineNum = 79;BA.debugLine="infoholder.AddView(singup,2.5%x,(loginbtn.Top + l";
_infoholder.AddView((android.view.View)(_singup.getObject()),__c.PerXToCurrent((float) (2.5),ba),(int) ((_loginbtn.getTop()+_loginbtn.getHeight())+__c.DipToCurrent((int) (5))),__c.PerXToCurrent((float) (35),ba),__c.PerYToCurrent((float) (5),ba));
 //BA.debugLineNum = 81;BA.debugLine="infoholder.SetLayoutAnimated(1000,30%x,30%y,40%x,";
...
b4a.example.types._user _u = null;
 //BA.debugLineNum = 103;BA.debugLine="Sub CheckUser";
 //BA.debugLineNum = 104;BA.debugLine="For Each u As user In userslist";
{
final anywheresoftware.b4a.BA.IterableList group1 = _userslist;
final int groupLen1 = group1.getSize()
;int index1 = 0;
;
for (; index1 < groupLen1;index1++){
_u = (b4a.example.types._user)(group1.Get(index1));
 //BA.debugLineNum = 105;BA.debugLine="If  usernamefield.Text = u.username Then";
if ((_usernamefield.getText()).equals(_u.username)) { 
 //BA.debugLineNum = 106;BA.debugLine="If passwordfield.Text = u.password Then";
if ((_passwordfield.getText()).equals(_u.password)) { 
 //BA.debugLineNum = 107;BA.debugLine="setuser(u)";
_setuser(_u);
...
_myxml.Initialize(ba);
 //BA.debugLineNum = 25;BA.debugLine="userslist.Initialize";
...
public String  _login_click() throws Exception{
 //BA.debugLineNum = 85;BA.debugLine="Sub login_Click";
 //BA.debugLineNum = 86;BA.debugLine="myxml.Parse(File.OpenInput(File.DirAssets,\"Exampl";
_myxml.Parse((java.io.InputStream)(__c.File.OpenInput(__c.File.getDirAssets(),"ExampleXML.xml").getObject()),"Parse");
 //BA.debugLineNum = 87;BA.debugLine="CheckUser";
_checkuser();
...
b4a.example.types._user _newuser = null;
 //BA.debugLineNum = 114;BA.debugLine="Sub Parse_EndElement (Uri As String, Name As Strin";
 //BA.debugLineNum = 115;BA.debugLine="If Name.EqualsIgnoreCase(\"user\") Then";
if (_name.equalsIgnoreCase("user")) { 
 //BA.debugLineNum = 116;BA.debugLine="Dim newUser As user";
_newuser = new b4a.example.types._user();
 //BA.debugLineNum = 117;BA.debugLine="newUser.Initialize";
_newuser.Initialize();
 //BA.debugLineNum = 118;BA.debugLine="newUser.available = workingUser.available";
_newuser.available = _workinguser.available;
 //BA.debugLineNum = 119;BA.debugLine="newUser.CurrentTaskID = workingUser.CurrentTaskI";
_newuser.CurrentTaskID = _workinguser.CurrentTaskID;
 //BA.debugLineNum = 120;BA.debugLine="newUser.ID = workingUser.ID";
_newuser.ID = _workinguser.ID;
 //BA.debugLineNum = 121;BA.debugLine="newUser.password = workingUser.password";
_newuser.password = _workinguser.password;
 //BA.debugLineNum = 122;BA.debugLine="newUser.username = workingUser.username";
_newuser.username = _workinguser.username;
 //BA.debugLineNum = 123;BA.debugLine="newUser.TypeOfWorker = workingUser.TypeOfWorker";
_newuser.TypeOfWorker = _workinguser.TypeOfWorker;
 //BA.debugLineNum = 124;BA.debugLine="userslist.Add(newUser)";
_userslist.Add((Object)(_newuser));
 };
 //BA.debugLineNum = 127;BA.debugLine="If Name.EqualsIgnoreCase(\"name\") Then workingUser";
if (_name.equalsIgnoreCase("name")) { 
_workinguser.username = _text.ToString();};
 //BA.debugLineNum = 128;BA.debugLine="If Name.EqualsIgnoreCase(\"password\") Then working";
if (_name.equalsIgnoreCase("password")) { 
_workinguser.password = _text.ToString();};
 //BA.debugLineNum = 129;BA.debugLine="If Name.EqualsIgnoreCase(\"available\") Then";
if (_name.equalsIgnoreCase("available")) { 
 //BA.debugLineNum = 130;BA.debugLine="If Text.ToString  = \"True\" Then";
if ((_text.ToString()).equals("True")) { 
 //BA.debugLineNum = 131;BA.debugLine="workingUser.available = True";
_workinguser.available = __c.True;
 }else {
 //BA.debugLineNum = 133;BA.debugLine="workingUser.available = False";
_workinguser.available = __c.False;
 };
 };
 //BA.debugLineNum = 136;BA.debugLine="If Name.EqualsIgnoreCase(\"TypeOfWorker\") Then wor";
if (_name.equalsIgnoreCase("TypeOfWorker")) { 
_workinguser.TypeOfWorker = (int)(Double.parseDouble(_text.ToString()));};
 //BA.debugLineNum = 137;BA.debugLine="If Name.EqualsIgnoreCase(\"id\") Then workingUser.I";
...
public String  _parse_startelement(String _uri,String _name,anywheresoftware.b4a.objects.SaxParser.AttributesWrapper _attributes) throws Exception{
 //BA.debugLineNum = 90;BA.debugLine="Sub Parse_StartElement (Uri As String, Name As Str";
 //BA.debugLineNum = 91;BA.debugLine="If Name.EqualsIgnoreCase(\"user\") Then";
if (_name.equalsIgnoreCase("user")) { 
 //BA.debugLineNum = 92;BA.debugLine="workingUser.Initialize";

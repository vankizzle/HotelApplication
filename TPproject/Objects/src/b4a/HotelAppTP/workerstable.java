...
public class workerstable extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.HotelAppTP.workerstable");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.HotelAppTP.workerstable.class).invoke(this, new Object[] {null});
        else
...
b4a.HotelAppTP.types._user _u = null;
...
_u = (b4a.HotelAppTP.types._user)(group2.Get(index2));

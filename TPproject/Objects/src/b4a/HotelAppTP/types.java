...
anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator _ojsongenerator2 = null;
 //BA.debugLineNum = 23;BA.debugLine="Sub getJSONforLogin(email As String,password As St";
 //BA.debugLineNum = 24;BA.debugLine="Dim keyValue As Map = CreateMap(\"email\":email,\"pa";
...
_keyvalue = anywheresoftware.b4a.keywords.Common.createMap(new Object[] {(Object)("email"),(Object)(_email),(Object)("password"),(Object)(_password)});
 //BA.debugLineNum = 25;BA.debugLine="Dim oJSONGenerator2 As JSONGenerator";
_ojsongenerator2 = new anywheresoftware.b4a.objects.collections.JSONParser.JSONGenerator();
 //BA.debugLineNum = 26;BA.debugLine="oJSONGenerator2.Initialize(keyValue)";
_ojsongenerator2.Initialize(_keyvalue);
 //BA.debugLineNum = 27;BA.debugLine="Return oJSONGenerator2.ToString";
...
public static boolean  _isboss(anywheresoftware.b4a.BA _ba) throws Exception{
 //BA.debugLineNum = 15;BA.debugLine="Public Sub Isboss As Boolean";
 //BA.debugLineNum = 16;BA.debugLine="If currentuser.TypeOfWorker = 0 Then";
...
;
 //BA.debugLineNum = 7;BA.debugLine="Type Task (TaskID As Int,TaskType As String,TaskI";
;

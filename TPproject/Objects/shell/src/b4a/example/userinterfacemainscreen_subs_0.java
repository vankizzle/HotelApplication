...
try {
		Debug.PushSubsStack("AsView (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("avail_Click (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,101);
...
try {
		Debug.PushSubsStack("BuildUI (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("Initialize (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,20);
...
Debug.ShouldStop(2);
__ref.getField(false,"_menuother2").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 35;BA.debugLine="MenuOther3.Initialize(\"\")";
Debug.ShouldStop(4);
__ref.getField(false,"_menuother3").runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("MyTask_Click (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("screenview_Click (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,118);
...
try {
		Debug.PushSubsStack("Tasks_Click (userinterfacemainscreen) ","userinterfacemainscreen",3,__ref.getField(false, "ba"),__ref,95);

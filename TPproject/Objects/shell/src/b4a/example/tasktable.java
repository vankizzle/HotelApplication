...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"boxchecked",_ref.getField(false, "_boxchecked"),"mapoftaskviews",_ref.getField(false, "_mapoftaskviews"),"refreshbtngraphic",_ref.getField(false, "_refreshbtngraphic"),"SelectedTasks",_ref.getField(false, "_selectedtasks"),"submit",_ref.getField(false, "_submit"),"tableFooter",_ref.getField(false, "_tablefooter"),"tableHeader",_ref.getField(false, "_tableheader"),"tableHolder",_ref.getField(false, "_tableholder"),"tableofrequests",_ref.getField(false, "_tableofrequests"),"tableType",_ref.getField(false, "_tabletype"),"TasksList",_ref.getField(false, "_taskslist"),"TasksRefreshBtn",_ref.getField(false, "_tasksrefreshbtn"),"WholeScreen",_ref.getField(false, "_wholescreen")};
}
}
...
try {
		Debug.PushSubsStack("AsView (loginscreen) ","loginscreen",4,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("BuildUI (loginscreen) ","loginscreen",4,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("Initialize (loginscreen) ","loginscreen",4,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("login_Click (loginscreen) ","loginscreen",4,__ref.getField(false, "ba"),__ref,80);
